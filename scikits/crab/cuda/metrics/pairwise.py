...
import numpy
from ...utils.safe import safe_asarray
...
def euclidean_distances(X, Y=None, inverse=True):
    ...
    Examples
    --------
    >>> from scikits.crab.cuda.metrics.pairwise import euclidean_distances
    >>> X = [[0, 1], [1, 1]]
...
def pearson_correlation(X, Y=None):
    ...
    Examples
    --------
    >>> from scikits.crab.cuda.metrics.pairwise import pearson_correlation
...
def manhattan_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from scikits.crab.cuda.metrics.pairwise import manhattan_distances
    >>> X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0],[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
    >>> # distance between rows of X
...
def minkowski(X, Y=None, P=1):
    ...
    Examples
   >>> from scikits.crab.cuda.metrics.pairwise import minkowski
    >>> X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0],[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
    >>> # distance between rows of X
    >>> minkowski(X, X, P=1)
   array([[ 0.,  0.],
...
def cosine_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from scikits.crab.cuda.metrics.pairwise import cosine_distances
    >>> X = [[2.5, 3.5, 3.0, 3.5, 2.5, 3.0],[2.5, 3.5, 3.0, 3.5, 2.5, 3.0]]
    >>> # distance between rows of X
